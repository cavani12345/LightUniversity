...
<a href="logout.php" id="log"><font size="+4">Log out</font></a> </font>
</div>
<br><br>
<div align="left" style="margin-left:20px; margin-top:50PX; border:solid red; border-right:none;">
<?php
$st_id=$_SESSION['id'];
$query="SELECT* FROM student_tb WHERE student_id=$st_id";
...
?>
<font size="+2">
Welcome Dear <?php echo $st_fname; 
}
?> you are now in the system and for sure you are our member.<br>
If you want to see your <b>proof of registration, </b> click <a href="get_proof.php" target="_blank"><font size="+2">Here!</font></a> </font>
</div>
