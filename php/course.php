...
{
alert("Please enter Department This course belong to");
...
<a href="welcome_admin.php" id="log"><font size="+3">Go Home</font></a> &nbsp; &nbsp; &nbsp; &nbsp;</div>
	...
	<form action="insert_course.php" method="post" onSubmit="return validi();">
	<table cellspacing="16">
	<tr><td><label>Course Name:</label></td><td><input type="text" id="cn" name="cname" placeholder="Enter course Name" autofocus></td></tr>
